...
// without any import path at all — they are all in the one CedarView module
// that CMakeLists.txt compiles into the binary.
//
// ---- Two palettes ---------------------------------------------------------
//
...
// (src/ui/settings.h), so the switch is a single property change that every
